...
import com.liferay.docs.amf.registration.exception.NoSuchAmfRegistrationException;
...
import com.liferay.docs.amf.registration.model.impl.AmfRegistrationModelImpl;
 ...
 * @see com.liferay.docs.amf.registration.service.persistence.AmfRegistrationUtil
 * @generated
 */
@ProviderType
public class AmfRegistrationPersistenceImpl extends BasePersistenceImpl<AmfRegistration>
	 ...
	 */
	@Override
	public AmfRegistration create(String fakeAttribute) {
		AmfRegistration amfRegistration = new AmfRegistrationImpl();

		amfRegistration.setNew(true);
		amfRegistration.setPrimaryKey(fakeAttribute);
	 ...
	 */
	@Override
	public AmfRegistration remove(String fakeAttribute)
		throws NoSuchAmfRegistrationException {
		return remove((Serializable)fakeAttribute);
	}
	...
	protected AmfRegistration toUnwrappedModel(AmfRegistration amfRegistration) {
		...
		amfRegistrationImpl.setFakeAttribute(amfRegistration.getFakeAttribute());
	 ...
	 */
	@Override
	public AmfRegistration findByPrimaryKey(String fakeAttribute)
		throws NoSuchAmfRegistrationException {
		return findByPrimaryKey((Serializable)fakeAttribute);
	}
	 ...
	 */
	@Override
	public AmfRegistration fetchByPrimaryKey(String fakeAttribute) {
		return fetchByPrimaryKey((Serializable)fakeAttribute);
	}
	...
	private static final String _SQL_SELECT_AMFREGISTRATION_WHERE_PKS_IN = "SELECT amfRegistration FROM AmfRegistration amfRegistration WHERE fakeAttribute IN (";
